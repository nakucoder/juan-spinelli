      ...
      <div className="container relative z-10 text-center max-w-3xl">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 mb-16">
              ...
              className="p-3 rounded-lg border border-border/50 text-muted-foreground hover:text-primary hover:border-primary/50 hover:glow-primary transition-all duration-300"
            >
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-lg border border-border/50 text-muted-foreground hover:text-primary hover:border-primary/50 transition-all duration-300"
            >
              <Linkedin className="w-5 h-5" />
            </a>
            
              href="mailto:juanakuspinelli@gmail.com"
              className="p-3 rounded-lg border border-border/50 text-muted-foreground hover:text-accent hover:border-accent/50 transition-all duration-300"
            >
